# QTA Lab 05: Supervised classification with House of Commons speeches
...
classifier. Naive Bayes predicts the most likely class given the
observed features. It does this by estimating how likely those features
are within each class and combining that with the prior probability of
each class.
