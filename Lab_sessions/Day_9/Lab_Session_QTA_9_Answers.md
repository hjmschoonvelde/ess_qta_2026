# QTA Lab 09 Answers: Zero-Shot Classification with NLI Models
...
![](Lab_Session_QTA_9_Answers_files/figure-commonmark/plot_zero_shot_labels_by_party-1.png)
...
```
    ...
    6 housing     This speech is about housing, rent, homes, tenants, planning, or …
    7 procedural  This speech is mainly procedural parliamentary business rather th…
    8 migration   This speech is about immigration, asylum, refugees, migrants, or …
...
```
    ...
    # A tibble: 10 × 5
       speech_id party_group  agenda                 predicted_label predicted_score
       <chr>     <fct>        <chr>                  <chr>                     <dbl>
     1 hoc_3471  Conservative Budget Resolutions An… economy                   0.5  
     2 hoc_3650  Labour       Iraq [Oral Answers To… economy                   0.125
     3 hoc_3762  Conservative <NA>                   security                  0.667
     4 hoc_3812  Labour       Museums and Galleries… economy                   0.667
     5 hoc_3887  Labour       European Affairs       economy                   0.125
     6 hoc_3912  Labour       Counter-Terrorism Bill security                  1    
     7 hoc_3996  Conservative Law Commission Bill [… procedural                1    
     8 hoc_4092  Conservative North Africa [Oral An… economy                   0.667
     9 hoc_4354  Conservative Greece                 housing                   1    
    10 hoc_4675  Conservative Point of Order         procedural                0.9  
...
```
    ...
    # A tibble: 4 × 6
      speech_id predicted_label predicted_score party_group  agenda   text_for_model
      <chr>     <chr>                     <dbl> <fct>        <chr>    <chr>         
    1 hoc_3812  economy                   0.667 Labour       Museums… "Sadly, the h…
    2 hoc_4354  housing                   1     Conservative Greece   "Let me deal …
    3 hoc_3996  procedural                1     Conservative Law Com… "My hon. Frie…
    4 hoc_3912  security                  1     Labour       Counter… "My right hon…
...
```
    ...
    # A tibble: 2 × 7
      speech_id predicted_label predicted_score weak_label max_keyword_score agenda 
      <chr>     <chr>                     <dbl> <chr>                  <int> <chr>  
    1 hoc_3650  economy                   0.125 unlabelled                 0 Iraq […
    2 hoc_3887  economy                   0.125 unlabelled                 0 Europe…
    # ℹ 1 more variable: text_for_model <chr>
